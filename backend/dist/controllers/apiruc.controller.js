...
exports.consultarRUC = void 0;
const axios_1 = __importDefault(require("axios"));
const consultarRUC = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const response = yield axios_1.default.get(`https://api.apis.net.pe/v1/ruc?numero=${ruc}`);
